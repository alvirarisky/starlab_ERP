...
REPORT_NAME = "Laporan Keuangan Operasional"
...
def execute():
	...
	app_path = frappe.get_app_path("starlab_customizations")
	report_dir = os.path.join(app_path, "starlab_customizations", "report", frappe.scrub(REPORT_NAME))
