...
# Konten diambil verbatim dari "Surat Penawaran Harga" asli SAI (Quo
# 075-PT Yanmar Indonesia, docs/dokumen asli/) -- sebelumnya TNC Master
# Template tidak punya versi terisi sama sekali (PRD v6 Open Question).
VERSI = "01"
KONTEN_TNC = """
<ol>
<li>Masa berlaku penawaran adalah 30 hari kalender sejak terbitnya surat ini.</li>
...
<ol type="a">
<li>Untuk pemesanan dengan nilai lebih dari sama dengan Rp10.000.000,- diharuskan melakukan pembayaran uang muka (down payment) 50% sebelum pekerjaan dilaksanakan dan pelunasan paling lambat 30 (tiga puluh) hari kalender setelah invoice diterima oleh pelanggan.</li>
